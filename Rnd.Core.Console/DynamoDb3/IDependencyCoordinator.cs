...
namespace Checkout.Marketplace.Core.Logging.Dependencies
{
    /// <summary>
...
namespace Checkout.Marketplace.Core.Logging.Dependencies
{
    ...
    public class DependencyCoordinator : IDependencyCoordinator
    {
        ...
        public DependencyCoordinator(ILogger<DependencyCoordinator> log)
        {
...
namespace Checkout.Marketplace.Core.Logging
{
    /// <summary>
